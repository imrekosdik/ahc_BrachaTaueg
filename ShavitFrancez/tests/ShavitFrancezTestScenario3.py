...
def main():
    ...
    components[0].termination_initiators.append(components[1].componentinstancenumber)
    components[1].termination_initiators.append(components[0].componentinstancenumber)
    components[2].termination_initiators.append(components[0].componentinstancenumber)
    components[1].termination_initiators.append(components[1].componentinstancenumber)
    components[2].termination_initiators.append(components[1].componentinstancenumber)
    ...
    time.sleep(10)
    components[2].send_self(Event(components[2], ShavitFrancezEventTypes.BECOMEPASSIVE, eventcontent="PASSIVE"))
    time.sleep(10)
